...
def evaluate_vectors(W, vocab):
    ...
    correct_sem = 0
    # count correct semantic questions
    correct_syn = 0
    # count correct syntactic questions
    correct_tot = 0  # count correct questions
    count_sem = 0
    # count all semantic questions
    count_syn = 0
    # count all syntactic questions
    ...
    print(
        "Semantic accuracy: %.2f%%  (%i/%i)"
        % (100 * correct_sem / float(count_sem), correct_sem, count_sem)
    )
    print(
        "Syntactic accuracy: %.2f%%  (%i/%i)"
        % (100 * correct_syn / float(count_syn), correct_syn, count_syn)
    )
    print(
        "Total accuracy: %.2f%%  (%i/%i)"
